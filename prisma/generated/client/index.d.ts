...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "wallet" | "transaction" | "transactionType"
  ...
  export type TransactionTypeCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    Transaction?: boolean | TransactionTypeCountOutputTypeCountTransactionArgs
  }
   ...
   * TransactionTypeCountOutputType without action
   */
  export type TransactionTypeCountOutputTypeCountTransactionArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    where?: TransactionWhereInput
  }
  ...
  export type WalletAvgAggregateOutputType = {
    ...
    all_incomes: number | null
    all_outcomes: number | null
    userId: number | null
  }
  ...
  export interface Prisma__WalletClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    Transaction<T extends Wallet$TransactionArgs<ExtArgs> = {}>(args?: Subset<T, Wallet$TransactionArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$TransactionPayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface WalletFieldRefs {
    ...
    readonly score: FieldRef<"Wallet", 'Float'>
    readonly total_transactions: FieldRef<"Wallet", 'Int'>
    readonly all_incomes: FieldRef<"Wallet", 'Float'>
    readonly all_outcomes: FieldRef<"Wallet", 'Float'>
  ...
  export type $TransactionPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    name: "Transaction"
    objects: {
      type: Prisma.$TransactionTypePayload<ExtArgs>
  ...
  export interface Prisma__TransactionClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    type<T extends TransactionTypeDefaultArgs<ExtArgs> = {}>(args?: Subset<T, TransactionTypeDefaultArgs<ExtArgs>>): Prisma__TransactionTypeClient<$Result.GetResult<Prisma.$TransactionTypePayload<ExtArgs>, T, "findUniqueOrThrow"> | Null, Null, ExtArgs>
  ...
  export type TransactionTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    id?: boolean
    type?: boolean
    Transaction?: boolean | TransactionType$TransactionArgs<ExtArgs>
  ...
  export interface Prisma__TransactionTypeClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    Transaction<T extends TransactionType$TransactionArgs<ExtArgs> = {}>(args?: Subset<T, TransactionType$TransactionArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$TransactionPayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface TransactionTypeFieldRefs {
    ...
    readonly type: FieldRef<"TransactionType", 'String'>
  }
   ...
   */
  export type TransactionType$TransactionArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Transaction
     */
    select?: TransactionSelect<ExtArgs> | null
  ...
  export type WalletWhereInput = {
    ...
    score?: FloatFilter<"Wallet"> | number
    total_transactions?: IntFilter<"Wallet"> | number
    all_incomes?: FloatFilter<"Wallet"> | number
    all_outcomes?: FloatFilter<"Wallet"> | number
  ...
  export type WalletOrderByWithRelationInput = {
    ...
    all_incomes?: SortOrder
    all_outcomes?: SortOrder
    created_at?: SortOrder
    updated_at?: SortOrder
    userId?: SortOrder
  ...
  export type WalletScalarWhereWithAggregatesInput = {
    ...
    score?: FloatWithAggregatesFilter<"Wallet"> | number
    total_transactions?: IntWithAggregatesFilter<"Wallet"> | number
    all_incomes?: FloatWithAggregatesFilter<"Wallet"> | number
    all_outcomes?: FloatWithAggregatesFilter<"Wallet"> | number
  ...
  export type TransactionWhereInput = {
    ...
    type?: XOR<TransactionTypeRelationFilter, TransactionTypeWhereInput>
  ...
  export type TransactionTypeWhereInput = {
    ...
    type?: StringFilter<"TransactionType"> | string
    Transaction?: TransactionListRelationFilter
  }
  ...
  export type TransactionTypeScalarWhereWithAggregatesInput = {
    ...
    type?: StringWithAggregatesFilter<"TransactionType"> | string
  }
  ...
  export type WalletUpdateInput = {
    ...
    all_incomes?: FloatFieldUpdateOperationsInput | number
    all_outcomes?: FloatFieldUpdateOperationsInput | number
    created_at?: DateTimeFieldUpdateOperationsInput | Date | string
    updated_at?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type TransactionCreateInput = {
    ...
    created_at?: Date | string
    updated_at?: Date | string
    type: TransactionTypeCreateNestedOneWithoutTransactionInput
  ...
  export type TransactionUpdateInput = {
    ...
    created_at?: DateTimeFieldUpdateOperationsInput | Date | string
    updated_at?: DateTimeFieldUpdateOperationsInput | Date | string
    type?: TransactionTypeUpdateOneRequiredWithoutTransactionNestedInput
  ...
  export type TransactionTypeCreateNestedOneWithoutTransactionInput = {
    create?: XOR<TransactionTypeCreateWithoutTransactionInput, TransactionTypeUncheckedCreateWithoutTransactionInput>
  ...
  export type TransactionTypeUpdateOneRequiredWithoutTransactionNestedInput = {
    create?: XOR<TransactionTypeCreateWithoutTransactionInput, TransactionTypeUncheckedCreateWithoutTransactionInput>
    connectOrCreate?: TransactionTypeCreateOrConnectWithoutTransactionInput
    upsert?: TransactionTypeUpsertWithoutTransactionInput
    connect?: TransactionTypeWhereUniqueInput
    update?: XOR<XOR<TransactionTypeUpdateToOneWithWhereWithoutTransactionInput, TransactionTypeUpdateWithoutTransactionInput>, TransactionTypeUncheckedUpdateWithoutTransactionInput>
  }
  ...
  export type TransactionTypeCreateWithoutTransactionInput = {
    type: string
  }

  export type TransactionTypeUncheckedCreateWithoutTransactionInput = {
    id?: number
    type: string
  }

  export type TransactionTypeCreateOrConnectWithoutTransactionInput = {
    where: TransactionTypeWhereUniqueInput
    create: XOR<TransactionTypeCreateWithoutTransactionInput, TransactionTypeUncheckedCreateWithoutTransactionInput>
  }
  ...
  export type TransactionTypeUpsertWithoutTransactionInput = {
    update: XOR<TransactionTypeUpdateWithoutTransactionInput, TransactionTypeUncheckedUpdateWithoutTransactionInput>
    create: XOR<TransactionTypeCreateWithoutTransactionInput, TransactionTypeUncheckedCreateWithoutTransactionInput>
    where?: TransactionTypeWhereInput
  }

  export type TransactionTypeUpdateToOneWithWhereWithoutTransactionInput = {
    where?: TransactionTypeWhereInput
    data: XOR<TransactionTypeUpdateWithoutTransactionInput, TransactionTypeUncheckedUpdateWithoutTransactionInput>
  }

  export type TransactionTypeUpdateWithoutTransactionInput = {
    type?: StringFieldUpdateOperationsInput | string
  }

  export type TransactionTypeUncheckedUpdateWithoutTransactionInput = {
    id?: IntFieldUpdateOperationsInput | number
    type?: StringFieldUpdateOperationsInput | string
  }
